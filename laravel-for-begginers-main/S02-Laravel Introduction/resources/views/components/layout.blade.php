...
<body>
            ...
            @auth
                <div class="flex-row my-3 my-md-0">
                    @if (auth()->user()->isAdmin === 1)
                        <span href="#" class="badge badge-light mr-2 user-select-none">Admin</span>
                    @endif
                    ...
                    <a href="/profile/{{ auth()->user()->username }}" class="mr-2">
                        <img alt title="My Profile" data-toggle="tooltip" data-placement="bottom"
                ...
                <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                            ...
                            @error('loginUsername')
                                <div class="mt-3 small alert alert-danger shadow-sm">{{ $message }}</div>
                            @enderror
    ...
    @elseif (session()->has('primary'))
        <div class="container container--narrow">
            <div class="alert alert-primary text-center">{{ session('primary') }}</div>
        </div>
