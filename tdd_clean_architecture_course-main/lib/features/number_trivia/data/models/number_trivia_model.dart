...
/// convenient for some external agency such as the Database or the Web. It is
/// this layer, for example, that will wholly contain the MVC architecture of a
/// GUI. The Presenters, Views, and Controllers all belong in here. The models
/// are likely just data structures that are passed from the controllers to the
